...
def main(ROOT_DIR):
    """Expects ROOT_DIR to be repo root"""
    ...
    ge_results = {}
    # file_path = ROOT_DIR / 'general_election' / '2010' / 'electoral_commission' / 'results' / 'clean'
    # ge_results['2010'] = pd.read_csv(file_path / 'ge_2010_results.csv')

    file_path = ROOT_DIR / 'general_election' / '2015' / 'electoral_commission' / 'results' / 'clean'
    ge_results['2015'] = pd.read_csv(file_path / 'ge_2015_results.csv')

    # Import EU Referendum results
    file_path = ROOT_DIR / 'eu_referendum' / 'electoral_commission' / 'results' / 'raw'
    ...
    # EXPORT
    file_path = ROOT_DIR / 'model' / 'clean'
